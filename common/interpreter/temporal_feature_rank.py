...
class TemporalFeatureRank(Interpreter):
    ...
    def interpret(self, env, m_project, model_checking_info):
        ...
        for _, elem in enumerate(model_checking_info["state_interconnections"]):
            ...
            n_interconnections.append((state, action_idx, action_name, all_next_states, feature_names, current_feature_rank, feature_ranks))
