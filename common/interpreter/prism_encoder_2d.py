class PrismEncoder2D:
    ...
    def get_feature_min_dictionary(self, interconnections):
        ...
        for interconnection in interconnections:
            ...
            n_feature = interconnection[-4]
            if "n_feature2" not in feature_mins:
                feature_mins["n_feature2"] = n_feature
            else:
                if n_feature < feature_mins["n_feature2"]:
                    feature_mins["n_feature2"] = n_feature
        #print(feature_mins)
        return feature_mins
    ...
    def get_feature_max_dictionary(self, interconnections):
        ...
        for interconnection in interconnections:
            ...
            if "n_feature2" not in feature_maxs:
                feature_maxs["n_feature2"] = n_feature
            else:
                if n_feature > feature_maxs["n_feature2"]:
                    feature_maxs["n_feature2"] = n_feature
        #print(feature_maxs)
        return feature_maxs
    ...
    def get_init_values(self, interconnections):
        ...
        for interconnection in interconnections:
            ...
            feature_inits["n_feature"] = interconnections[0][-4]
            feature_inits["n_feature2"] = interconnections[0][-2]
            break
    ...
    def encode(self):
        ...
        for interconnection in self.interconnections:
            ...
            n_feature=interconnection[5]
            n_feature2=interconnection[7]
            ...
            for idx, next_state in enumerate(all_next_states):
                # Next states come here
                prism_str += f" {next_state[1]} : {self.get_update(next_state[0], feature_names)} & (n_feature'={interconnection[-3][idx]}) & (n_feature2'={interconnection[-1][idx]}) +"
