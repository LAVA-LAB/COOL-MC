...
class TurnBasedNReinforceAgents(StochasticAgent):
    ...
    def load(self, model_root_folder_path):
        ...
        for i in range(self.number_of_agents):
            ...
            self.agents.append(ReinforceAgent(self.state_dimension, self.number_of_neurons, self.number_of_actions, gamma=self.command_line_arguments['gamma'], lr=self.command_line_arguments['lr']))
