...
python cool_mc.py --parent_run_id="738491a041614574b9d6a6501a915356" --project_name="avoid_experiments" --constant_definitions="xMax=8,yMax=8,slickness=0.1" --prism_dir="../prism_files" --seed=128 --prism_file_path="avoid.prism" --task="rl_model_checking" --prop="P=? [ F<=100 COLLISION=true ]" --interpreter="temporal_critical_state_interpreter;P=? [ F (n_feature=1) ];700"
