...
#python cool_mc.py --project_name="crazy_experiments" --constant_definitions="" --prism_dir="../prism_files" --prism_file_path="crazy_climber.prism" --seed=128 --layers=2 --neurons=1024 --lr=0.0001 --batch_size=32 --num_episodes=1000000 --eval_interval=100 --epsilon_dec=0.99999 --epsilon_min=0.1 --gamma=0.99 --epsilon=1 --replace=301 --reward_flag=1 --wrong_action_penalty=0 --prop="" --max_steps=100 --replay_buffer_size=300000
python cool_mc.py --parent_run_id="4474e97b8a854ea591f3d584394fcb3a" --project_name="crazy_experiments" --constant_definitions="" --prism_dir="../prism_files" --prism_file_path="crazy_climber.prism" --seed=128 --task="rl_model_checking" --prop="P=? [ F COLLISION=true ]" --interpreter=""
